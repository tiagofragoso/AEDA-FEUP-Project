 ...
 */
	...
	*/
	...
	/**
	* @brief Deletes a Passenger chosen by the user from the Flight pointed by the argument passed
	* @param flight Flight* flight
	*/
	void flightDeletePassenger(Flight * flight);
	/**
	* @brief Updates buyer of the Flight passed as argument to the one chosen by the user
	* @param flight Flight* flight
	*/
